...
public class Constants {
    public static class SqlQuery {
        ...
        public static final String SELECT_FROM_CERTIFICATES = "SELECT * FROM certificates left join certificates_has_tags on certificates.id=certificates_has_tags.certificates_id left join tags on certificates_has_tags.tags_id=tags.id";
    ...
    public static class BuildQuery {
        public static final String SEARCH_BASE_QUERY = "SELECT * FROM certificates LEFT JOIN certificates_has_tags ON certificates.id=certificates_id LEFT JOIN tags ON tags_id=tags.id WHERE";
    ...
    public static class TableColumnsName {
