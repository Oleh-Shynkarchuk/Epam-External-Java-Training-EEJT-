...
public class Constants {
    public static class SqlQuery {
        ...
        public static final String SELECT_FROM_CERTIFICATES = "SELECT * FROM certificates join certificates_has_tags on certificates.id=certificates_has_tags.certificates_id left join tags on certificates_has_tags.tags_id=tags.id";
