...
insert into users (email,password,role,provider) values ('testUser3@mail.com','$2a$10$4vsKr.gKZtJV3TyCpOrePONcbkR7/RywupRuiPFVvZukCgfRNmSP.','USER','BASIC')
insert into users (email,password,role,provider) values ('testUser2@mail.com','TestPassword','ADMIN','BASIC')
insert into users (email,password,role,provider) values ('testUser1@mail.com','TestPassword','USER','BASIC')
